...
ggplot(data = diamonds.sample) +
  geom_point(mapping = aes(x = carat, y = price, colour = carat))
...
ggplot(data = diamonds.sample) +
  geom_point(mapping = aes(x = carat, y = price, colour = cut, alpha = 0.5))

# multiple geoms (point & smooth)

ggplot(data = diamonds.sample) +
  geom_smooth(mapping = aes(x = carat, y = price, colour = cut, alpha = 0.5))
